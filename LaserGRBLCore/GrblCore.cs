...
namespace LaserGRBLCore
{
	...
	public class GrblCore
	{
		...
		{
            get { return SettingsManager.Shared.GrblConf; }
			set
			{
				if (value.Count > 0 && value.mVersion != null)
				{
                    SettingsManager.Shared.GrblConf = value;
		...
		public void Configure(params object[] conf)
		{
            if (com == null)
            {
                com = new Comms.UsbSerial();
        ...
        public System.Collections.Generic.List<IGrblRow> GetSentCommands()
        {
            return mSent;
        }
        public System.Collections.Generic.List<IGrblRow> GetPendingCommands()
        {
            return mPending.Select(cw => (IGrblRow)cw).ToList();
        }
        public System.Collections.Generic.List<IGrblRow> GetQueuedCommands()
        {
            return mQueue.Select(cw => (IGrblRow)cw).ToList();
        }
		...
		public bool CanReOpenFile
		{
			get
			{
                string lastFile = SettingsManager.Shared.LastOpenFile;
		...
		{ get { return SettingsManager.Shared.ThreadingMode; } }

		private StreamingMode CurrentStreamingMode
		{ get { return SettingsManager.Shared.StreamingMode; } }
